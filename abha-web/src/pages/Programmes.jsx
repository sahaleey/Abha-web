...
const ProgrammeCard = ({ item }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{
        scale: 1.02, // Reduced from 1.03 for faster response
    ...
    >
      ...
      <motion.div className="relative overflow-hidden">
        <motion.img
          ...
          whileHover={{
            scale: 1.05, // Reduced from 1.1 for faster response
            transition: { duration: 0.2 }, // Faster hover
          }}
        />

        {/* Always visible mini details - now appears instantly */}
      ...
      {/* Expanded details - now much faster */}
      <motion.div
        layout
        ...
        transition={{
          type: "spring",
          stiffness: 400, // Much stiffer spring
          damping: 30,
      ...
      >
        <div className="px-4 py-3">
          ...
          {/* Description - appears instantly with the rest */}
